...
const emailTemplateSchema = new mongoose.Schema({
  name: { type: String, required: true }, // Name of the template (e.g., "Welcome Email")
  ...
  documentType: { type: String, required: true }, // The content of the email (HTML or plain text)
