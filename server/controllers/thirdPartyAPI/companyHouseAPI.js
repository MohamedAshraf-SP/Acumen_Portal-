...
export const searchCompanies = async (req, res) => {
    try {
        const companies = await companyHouse("/search/companies", `q=${req.params.companyName}`)
...
export const getOfficers = async (req, res) => {
    try {
        const officers = await companyHouse("/company/" + req.params.companyNumber + "/officers")
