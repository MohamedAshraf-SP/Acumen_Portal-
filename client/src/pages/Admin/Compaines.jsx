...
const Compaines = () => {
  ...
  useEffect(() => {
    dispatch(FetchedItems("Companies/abstracted"));
  }, [dispatch]);
    ...
    <>
      ...
      <div className="my-8 rounded-lg shadow-sm bg-white overflow-scroll dark:bg-secondary-dark-bg dark:text-gray-200">
        ...
        <div className="flex justify-between items-center p-4 border-b dark:border-gray-700">
          <h4 className="text-xl font-semibold">Compaines</h4>
          <Link
          ...
          {status === "success" && companies?.length > 0 && (
            ...
            >
              <ColumnsDirective>
                ...
                <ColumnDirective
                  field="email"
                  headerText="Contact Person Name"
                  width="200"
                  textAlign="center"
                />
                <ColumnDirective
                  ...
                  template={(rowData) => (
                    <ul className="flex items-center justify-center space-x-2 text-[14px]">
                      <ActionButton
                        ...
                        onClick={() =>
                          handleAction("edit", "Companies", rowData?._id)
                        }
                      />
                      <ActionButton
                        tooltip="Delete"
                        ...
                        onClick={() =>
                          handleAction("delete", "Companies", rowData?._id)
                        }
                      />
                    </ul>
                  )}
